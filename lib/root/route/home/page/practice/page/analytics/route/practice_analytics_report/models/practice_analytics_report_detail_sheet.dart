...
class PracticeAnalyticsReportDetailSheet extends StatelessWidget {
  static Future<void> show({
    ...
    return showMaterialModalBottomSheet(
      ...
      builder: (context) => PracticeAnalyticsReportDetailSheet._(
      ),
    );
  }

  const PracticeAnalyticsReportDetailSheet._();
